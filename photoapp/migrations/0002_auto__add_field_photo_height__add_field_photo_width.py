...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'photoapp_photo', 'height')

        # Deleting field 'Photo.width'
        db.delete_column(u'photoapp_photo', 'width')
